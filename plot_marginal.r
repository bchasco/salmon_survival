...
par(mfrow=c(2,2))
 plot(plogis(sdList$est[[1]]$mar_y),plogis(sdList$est[[3]]$mar_y), pch=16, cex=1.4, xlim=c(0,0.05),ylim=c(0,0.05))
 for(i in 1:length(sdList$est[[3]]$mar_y)){
 segments(plogis(sdList$est[[1]]$mar_y[i]+1.28*sdList$sd[[1]]$mar_y[i]),
 ...
 plot(plogis(sdList$est[[1]]$mar_j),plogis(sdList$est[[3]]$mar_j), pch=16, cex=1.4, xlim=c(0,0.02),ylim=c(0,0.02))
 ...
 plot(plogis(sdList$est[[1]]$mar_l),plogis(sdList$est[[3]]$mar_l), pch=16, cex=1.4, xlim=c(0,0.02),ylim=c(0,0.02))
